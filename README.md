...
[![Foodgram](https://github.com/Life31/foodgram-project-react/workflows/Foodgram-workflow/badge.svg?branch=master&event=push)](https://github.com/Life31/foodgram-project-react/actions/workflows/foodgram_workflow.yml)

Cайт, на котором пользователи могут публиковать рецепты,
добавлять чужие рецепты в избранное и подписываться на публикации других авторов.
Сервис **«Список покупок»** позволяет пользователям создавать список продуктов, которые
...
### Страница покупок
На странице — доступны все добавленные в список рецепты. Кнопка "Скачать список" инициирует экспорт pdf-файла с суммированным перечнем и количеством необходимых ингредиентов для всех рецептов, сохранённых в «Списке покупок».
...
1. Клонируйте репозиторий на локальную машину.
   ```https://github.com/Life31/foodgram-project-react.git```
